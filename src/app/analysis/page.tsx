        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <Link href="/analysis" className="text-emerald-400 text-sm font-medium">Analysis</Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Deep dive into match statistics, team performance, and AI insights
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-gray-500">Advanced analysis tools are on the way</p>
          </div>
        </div>
      </main>
