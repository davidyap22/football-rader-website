...
const translations: Record<string, Record<string, string>> = {
  ...
  FR: {
    ...
    blogTitle: "Blog Pronostics Foot",
    blogSubtitle: "Conseils paris sportifs, guides de cotes et analyses IA pour des pronostics plus intelligents",
    all: "Tout",
    tutorials: "Tutoriels",
    insights: "Analyses",
    ...
    communityFooter: "Communauté", globalChat: "Chat Global", userPredictions: "Pronostics Utilisateurs",
    ...
    disclaimer: "Avertissement : OddsFlow fournit des pronostics basés sur l'IA à des fins d'information et de divertissement uniquement. Nous ne garantissons pas l'exactitude des pronostics et ne sommes pas responsables des pertes financières. Le jeu comporte des risques. Veuillez jouer de manière responsable. Si vous ou quelqu'un que vous connaissez a un problème de jeu, veuillez demander de l'aide. Les utilisateurs doivent avoir plus de 18 ans.",
    footerDesc: "Analyses de cotes alimentées par l'IA pour des pronostics foot plus intelligents. Prenez des décisions basées sur les données avec des informations en temps réel.",
  },
  JA: {
  ...
  KO: {
    home: "홈", predictions: "축구 픽", leagues: "리그", performance: "분석",
    community: "커뮤니티", news: "뉴스", pricing: "가격", login: "로그인", getStarted: "시작하기",
    blogTitle: "축구 토토 분석 블로그",
    blogSubtitle: "AI 승무패 예측, 배당률 분석, 오늘의 축구 픽 가이드",
    all: "전체",
    tutorials: "가이드",
    insights: "분석",
    updates: "업데이트",
    ...
    communityFooter: "커뮤니티", globalChat: "글로벌 채팅", userPredictions: "사용자 픽",
    ...
    disclaimer: "면책조항: OddsFlow는 정보 및 엔터테인먼트 목적으로만 AI 기반 축구 픽을 제공합니다. 픽의 정확성을 보장하지 않으며 재정적 손실에 대해 책임지지 않습니다. 도박에는 위험이 따릅니다. 책임감 있게 베팅하세요. 본인 또는 아는 사람이 도박 문제가 있다면 도움을 구하세요. 사용자는 18세 이상이어야 합니다.",
    footerDesc: "더 스마트한 픽을 위한 AI 기반 축구 배당률 분석. 실시간 인사이트로 데이터 기반 토토 분석을 하세요.",
  },
  '中文': {
    home: "首页", predictions: "盘口分析", leagues: "联赛", performance: "分析",
    community: "社区", news: "新闻", pricing: "价格", login: "登录", getStarted: "开始",
    blogTitle: "足球盘口分析博客",
    blogSubtitle: "亚盘水位解读、让球分析、大小球投注策略与AI预测指南",
    all: "全部",
    tutorials: "教程",
    insights: "盘口分析",
    updates: "更新",
    ...
    disclaimer: "免责声明：OddsFlow 提供的 AI 盘口分析仅供参考和娱乐目的。我们不保证预测的准确性，也不对任何财务损失负责。博彩有风险，请理性投注。如果您或您认识的人有赌博问题，请寻求帮助。用户必须年满 18 岁。",
    footerDesc: "AI驱动的足球盘口分析，亚盘水位解读助您做出更明智的投注决策。",
  },
  '繁體': {
    home: "首頁", predictions: "運彩分析", leagues: "聯賽", performance: "分析",
    community: "社區", news: "新聞", pricing: "價格", login: "登入", getStarted: "開始",
    blogTitle: "運彩分析部落格",
    blogSubtitle: "讓分盤解讀、大小分投注策略、串關攻略與AI足球預測",
    all: "全部",
    tutorials: "下注教學",
    insights: "運彩分析",
    updates: "更新",
    ...
    responsibleGaming: "負責任投注",
    allRightsReserved: "版權所有。",
    gamblingWarning: "運彩有風險，請理性投注。",
    disclaimer: "免責聲明：OddsFlow 提供的 AI 運彩分析僅供參考和娛樂目的。我們不保證預測的準確性，也不對任何財務損失負責。運彩有風險，請理性投注。如果您或您認識的人有賭博問題，請尋求幫助。用戶必須年滿 18 歲。",
    footerDesc: "AI驅動的運彩分析，讓分盤、大小分、串關攻略助您提升勝率。",
  },
  ID: {
    home: "Beranda", predictions: "Prediksi Jitu", leagues: "Liga", performance: "Performa AI",
    community: "Komunitas", news: "Berita", pricing: "Harga", login: "Masuk", getStarted: "Mulai",
    blogTitle: "Blog Prediksi Bola Jitu",
    blogSubtitle: "Strategi mix parlay gacor, analisis pasaran bola, dan tips anti-rungkad",
    all: "Semua",
    tutorials: "Panduan",
    insights: "Analisis",
    updates: "Pembaruan",
    ...
    responsibleGaming: "Bertaruh Bertanggung Jawab",
    allRightsReserved: "Hak cipta dilindungi.",
    gamblingWarning: "Taruhan melibatkan risiko. Harap bertaruh dengan bijak.",
    disclaimer: "Penafian: OddsFlow menyediakan prediksi bola AI hanya untuk tujuan informasi dan hiburan. Kami tidak menjamin keakuratan prediksi dan tidak bertanggung jawab atas kerugian finansial. Taruhan melibatkan risiko. Harap bertaruh dengan bijak. Jika Anda atau seseorang yang Anda kenal memiliki masalah, silakan cari bantuan. Pengguna harus berusia 18+ tahun.",
    footerDesc: "Prediksi bola jitu bertenaga AI untuk mix parlay gacor. Analisis pasaran bola dan kei untuk keputusan yang lebih cerdas.",
  },
};
