...
const privacyContent: Record<string, {
  ...
  DE: {
    ...
    sections: [
      { title: "1. Einführung", text: "Willkommen bei OddsFlow. Wir sind dem Schutz Ihrer Privatsphäre verpflichtet, während Sie unsere KI-gesteuerte Sportanalyseplattform nutzen. Diese Richtlinie beschreibt, wie wir Ihre Daten behandeln, um Ihnen hochwertige Marktintelligenz und Spielprognose-Einblicke zu bieten." },
