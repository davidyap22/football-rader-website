...
const privacyContent: Record<string, {
  ...
  FR: {
    ...
    sections: [
      { title: "1. Introduction", text: "Bienvenue chez OddsFlow. Cette politique de confidentialité est établie conformément au RGPD (Règlement Général sur la Protection des Données). Nous nous engageons à protéger votre vie privée et vos données personnelles lorsque vous utilisez notre plateforme d'analyse sportive basée sur l'IA. Ce document décrit comment nous traitons vos données pour vous fournir une intelligence de marché de haute qualité et des informations de prévision de matchs." },
