...
export default function PlayerDetailClient({ player, locale, leagueSlug }: PlayerDetailClientProps) {
  ...
  // Helper for language dropdown URLs with SEO-friendly player slug
  const getLocaleUrl = (targetLocale: Locale): string => {
    const playerSlug = playerNameToSlug(player.player_name);
    const currentPath = `/leagues/${leagueSlug}/player/${playerSlug}-${player.id}`;
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="relative z-10 pt-24 pb-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Player Header - SSR content visible to crawlers */}
